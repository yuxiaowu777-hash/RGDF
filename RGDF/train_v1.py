...
parser.add_argument('--remove_1hop_edges', action='store_true',default=True)
...
if __name__ == '__main__':
    ...
    checkPath('./results_v1/')
    checkPath(f'./results_v1/{dataset}/')
    checkPath(f'{loader.task_dir}/saveModel_v1/')

    model = BaseModel(opts, loader)
    opts.perf_file = f'results_v1/{dataset}/{model.modelName}_perf.txt'
