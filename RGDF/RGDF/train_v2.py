...
from base_model_v2 import BaseModel
from utils import *
...
if __name__ == '__main__':
    ...
    checkPath('./results_v2/')
    checkPath(f'./results_v2/{dataset}/')
    checkPath(f'{loader.task_dir}/saveModel_v2/')

    model = BaseModel(opts, loader)
    opts.perf_file = f'results_v2/{dataset}/{model.modelName}_perf.txt'
