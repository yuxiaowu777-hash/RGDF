...
import torch
import numpy as np
from load_data_v3 import DataLoader
from base_model_v3 import BaseModel
from utils import *

parser = argparse.ArgumentParser(description="Parser for RGDF")
...
parser.add_argument('--epoch', type=int, default=330)
...
if __name__ == '__main__':
    ...
    if dataset == 'family':
        ...
        opts.n_batch = opts.n_tbatch = 120
    ...
    checkPath('./results_v3/')
    checkPath(f'./results_v3/{dataset}/')
    checkPath(f'{loader.task_dir}/saveModel_v3/')

    model = BaseModel(opts, loader)
    opts.perf_file = f'results_v3/{dataset}/{model.modelName}_perf.txt'
